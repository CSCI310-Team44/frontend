...
public class LoginActivityTest {
    ...
    public void loginActivityTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.netID), withText("NetID: 1000000001"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView.check(matches(withText("NetID: 1000000001")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.fullName), withText("Name: mark redekopp"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView2.check(matches(withText("Name: mark redekopp")));
    }
}
