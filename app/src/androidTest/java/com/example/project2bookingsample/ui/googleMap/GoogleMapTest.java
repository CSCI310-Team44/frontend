...
public class GoogleMapTest {
    ...
    @Test
    public void googleMapTest() throws UiObjectNotFoundException, InterruptedException {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.selectedCenter), withText("Village Fitness Center"),
                        withParent(allOf(withId(R.id.constraintLayout),
                                withParent(withId(android.R.id.content)))),
                        isDisplayed()));
        textView.check(matches(withText("Village Fitness Center")));
    }
