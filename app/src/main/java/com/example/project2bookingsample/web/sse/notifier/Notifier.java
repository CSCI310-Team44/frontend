...
import com.example.project2bookingsample.web.sse.SSEPlainTextConsumer;
...
public class Notifier {
    ...
    public void start() {
        ...
        try {
            String urlFmt = "http://10.0.2.2:8080/api/notification?userid=%d";
            @SuppressLint("DefaultLocale") URL url = new URL(String.format(urlFmt, userId));
